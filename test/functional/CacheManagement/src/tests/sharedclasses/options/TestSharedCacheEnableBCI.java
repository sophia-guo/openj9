...
public class TestSharedCacheEnableBCI extends TestUtils {
	...
	private static final String BOOTSTRAP_CLASS = "java/lang/Class";
	...
	/**
	 * 1. Create a cache without an agent and without enableBCI option.
	 * <p>
	...
	static void runTest1() {
		...
		if (isMVS() == false) {
			/* Create a cache without an agent and without enableBCI option. */
	...
	static void runTest4() {
		...
		if (isMVS() == false) {
			...
			if (classFileLoadHookCount < MIN_EXPECTED_ROMCLASSES) {
